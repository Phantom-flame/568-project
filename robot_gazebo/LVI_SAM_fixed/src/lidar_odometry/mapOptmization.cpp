...
public:
    ...
    void publishGlobalMap()
    {
        ...
        //publishCloud(&pubLaserCloudSurround, globalMapKeyFramesDS, timeLaserInfoStamp, "odom_est");    
    }
    ...
    void performLoopClosure(const std_msgs::Float64MultiArray& loopMsg)
    {
        ...
        pcl::PointCloud<PointType>::Ptr prevKeyframeCloud(new pcl::PointCloud<PointType>());
        {
            ...
            if (pubHistoryKeyFrames.getNumSubscribers() != 0)
                ...
                //publishCloud(&pubHistoryKeyFrames, prevKeyframeCloud, timeLaserInfoStamp, "odom_est");
        ...
        if (pubIcpKeyFrames.getNumSubscribers() != 0)
        {
            ...
            //publishCloud(&pubIcpKeyFrames, closed_cloud, timeLaserInfoStamp, "odom_est");
        }
        ...
        if (!loopIndexContainer.empty())
        {
            ...
            //markerNode.header.frame_id = "odom_est";
            ...
            //markerEdge.header.frame_id = "odom_est";
    ...
    void publishOdometry()
    {
        ...
        //laserOdometryROS.header.frame_id = "odom_est";
        ...
        //tf::StampedTransform trans_odom_to_lidar = tf::StampedTransform(t_odom_to_lidar, timeLaserInfoStamp, "odom_est", "lidar_link");
    ...
    void updatePath(const PointTypePose& pose_in)
    {
        ...
        //pose_stamped.header.frame_id = "odom_est";
    ...
    void publishFrames()
    {
        ...
        //publishCloud(&pubKeyPoses, cloudKeyPoses6D, timeLaserInfoStamp, "odom_est");
        // Publish surrounding key frames
        publishCloud(&pubRecentKeyFrames, laserCloudSurfFromMapDS, timeLaserInfoStamp, "odom");
        //publishCloud(&pubRecentKeyFrames, laserCloudSurfFromMapDS, timeLaserInfoStamp, "odom_est");
        ...
        if (pubRecentKeyFrame.getNumSubscribers() != 0)
        {
            ...
            *cloudOut += *transformPointCloud(laserCloudSurfLastDS,    &thisPose6D);
            ...
            //publishCloud(&pubRecentKeyFrame, cloudOut, timeLaserInfoStamp, "odom_est");
        }
        ...
        if (pubCloudRegisteredRaw.getNumSubscribers() != 0)
        {
            ...
            *cloudOut = *transformPointCloud(cloudOut,  &thisPose6D);
            ...
            //publishCloud(&pubCloudRegisteredRaw, cloudOut, timeLaserInfoStamp, "odom_est");
        }
        // publish path
        if (pubPath.getNumSubscribers() != 0)
        {
            ...
            //globalPath.header.frame_id = "odom_est";
