...
(cl:defmethod cl:initialize-instance :after ((m <cloud_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cloud_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lvi_sam-msg:<cloud_info> is deprecated: use lvi_sam-msg:cloud_info instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:header-val is deprecated.  Use lvi_sam-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'startRingIndex-val :lambda-list '(m))
(cl:defmethod startRingIndex-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:startRingIndex-val is deprecated.  Use lvi_sam-msg:startRingIndex instead.")
  (startRingIndex m))

(cl:ensure-generic-function 'endRingIndex-val :lambda-list '(m))
(cl:defmethod endRingIndex-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:endRingIndex-val is deprecated.  Use lvi_sam-msg:endRingIndex instead.")
  (endRingIndex m))

(cl:ensure-generic-function 'pointColInd-val :lambda-list '(m))
(cl:defmethod pointColInd-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:pointColInd-val is deprecated.  Use lvi_sam-msg:pointColInd instead.")
  (pointColInd m))

(cl:ensure-generic-function 'pointRange-val :lambda-list '(m))
(cl:defmethod pointRange-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:pointRange-val is deprecated.  Use lvi_sam-msg:pointRange instead.")
  (pointRange m))

(cl:ensure-generic-function 'imuAvailable-val :lambda-list '(m))
(cl:defmethod imuAvailable-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:imuAvailable-val is deprecated.  Use lvi_sam-msg:imuAvailable instead.")
  (imuAvailable m))

(cl:ensure-generic-function 'odomAvailable-val :lambda-list '(m))
(cl:defmethod odomAvailable-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:odomAvailable-val is deprecated.  Use lvi_sam-msg:odomAvailable instead.")
  (odomAvailable m))

(cl:ensure-generic-function 'imuRollInit-val :lambda-list '(m))
(cl:defmethod imuRollInit-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:imuRollInit-val is deprecated.  Use lvi_sam-msg:imuRollInit instead.")
  (imuRollInit m))

(cl:ensure-generic-function 'imuPitchInit-val :lambda-list '(m))
(cl:defmethod imuPitchInit-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:imuPitchInit-val is deprecated.  Use lvi_sam-msg:imuPitchInit instead.")
  (imuPitchInit m))

(cl:ensure-generic-function 'imuYawInit-val :lambda-list '(m))
(cl:defmethod imuYawInit-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:imuYawInit-val is deprecated.  Use lvi_sam-msg:imuYawInit instead.")
  (imuYawInit m))

(cl:ensure-generic-function 'odomX-val :lambda-list '(m))
(cl:defmethod odomX-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:odomX-val is deprecated.  Use lvi_sam-msg:odomX instead.")
  (odomX m))

(cl:ensure-generic-function 'odomY-val :lambda-list '(m))
(cl:defmethod odomY-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:odomY-val is deprecated.  Use lvi_sam-msg:odomY instead.")
  (odomY m))

(cl:ensure-generic-function 'odomZ-val :lambda-list '(m))
(cl:defmethod odomZ-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:odomZ-val is deprecated.  Use lvi_sam-msg:odomZ instead.")
  (odomZ m))

(cl:ensure-generic-function 'odomRoll-val :lambda-list '(m))
(cl:defmethod odomRoll-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:odomRoll-val is deprecated.  Use lvi_sam-msg:odomRoll instead.")
  (odomRoll m))

(cl:ensure-generic-function 'odomPitch-val :lambda-list '(m))
(cl:defmethod odomPitch-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:odomPitch-val is deprecated.  Use lvi_sam-msg:odomPitch instead.")
  (odomPitch m))

(cl:ensure-generic-function 'odomYaw-val :lambda-list '(m))
(cl:defmethod odomYaw-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:odomYaw-val is deprecated.  Use lvi_sam-msg:odomYaw instead.")
  (odomYaw m))

(cl:ensure-generic-function 'odomResetId-val :lambda-list '(m))
(cl:defmethod odomResetId-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:odomResetId-val is deprecated.  Use lvi_sam-msg:odomResetId instead.")
  (odomResetId m))

(cl:ensure-generic-function 'cloud_deskewed-val :lambda-list '(m))
(cl:defmethod cloud_deskewed-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:cloud_deskewed-val is deprecated.  Use lvi_sam-msg:cloud_deskewed instead.")
  (cloud_deskewed m))

(cl:ensure-generic-function 'cloud_corner-val :lambda-list '(m))
(cl:defmethod cloud_corner-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:cloud_corner-val is deprecated.  Use lvi_sam-msg:cloud_corner instead.")
  (cloud_corner m))

(cl:ensure-generic-function 'cloud_surface-val :lambda-list '(m))
(cl:defmethod cloud_surface-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lvi_sam-msg:cloud_surface-val is deprecated.  Use lvi_sam-msg:cloud_surface instead.")
  (cloud_surface m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cloud_info>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'odomY))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'odomZ))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'odomRoll))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'odomPitch))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'odomYaw))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let* ((signed (cl:slot-value msg 'odomResetId)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cloud_info>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'pointRange)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'odomZ) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'odomRoll) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'odomPitch) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'odomResetId) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cloud_info>)))
  ...
  "b20d53b871fbcd5cfbe0760777a7af32")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cloud_info)))
  "Returns md5sum for a message object of type 'cloud_info"
  "b20d53b871fbcd5cfbe0760777a7af32")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cloud_info>))
  ...
  (cl:list 'cloud_info
    ...
    (cl:cons ':odomZ (odomZ msg))
    (cl:cons ':odomRoll (odomRoll msg))
    (cl:cons ':odomPitch (odomPitch msg))
    (cl:cons ':odomYaw (odomYaw msg))
    (cl:cons ':odomResetId (odomResetId msg))
