...
if(lvi_sam_CONFIG_INCLUDED)
  return()
endif()
set(lvi_sam_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lvi_sam_SOURCE_PREFIX /home/shivam/catkin_ws3/src/LVI-SAM-Easyused)
  set(lvi_sam_DEVEL_PREFIX /home/shivam/catkin_ws3/devel)
  set(lvi_sam_INSTALL_PREFIX "")
  set(lvi_sam_PREFIX ${lvi_sam_DEVEL_PREFIX})
else()
  set(lvi_sam_SOURCE_PREFIX "")
  set(lvi_sam_DEVEL_PREFIX "")
  set(lvi_sam_INSTALL_PREFIX /home/shivam/catkin_ws3/install)
  set(lvi_sam_PREFIX ${lvi_sam_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lvi_sam' is deprecated")
...
set(lvi_sam_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/shivam/catkin_ws3/devel/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(lvi_sam_INCLUDE_DIRS "")
  set(_include_dirs "/home/shivam/catkin_ws3/devel/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'lalala <shant@mit.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lvi_sam_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lvi_sam' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lvi_sam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shivam/catkin_ws3/src/LVI-SAM-Easyused/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lvi_sam_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lvi_sam_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lvi_sam_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lvi_sam_NUM_DUMMY_TARGETS)
      set(lvi_sam_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lvi_sam::wrapped-linker-option${lvi_sam_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lvi_sam_NUM_DUMMY_TARGETS "${lvi_sam_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lvi_sam::wrapped-linker-option${lvi_sam_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lvi_sam_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shivam/catkin_ws3/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(lvi_sam_LIBRARY_DIRS ${lib_path})
      list(APPEND lvi_sam_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lvi_sam'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lvi_sam_LIBRARIES ${lib})
    endif()
  endif()
...
set(lvi_sam_EXPORTED_TARGETS "lvi_sam_generate_messages_cpp;lvi_sam_generate_messages_eus;lvi_sam_generate_messages_lisp;lvi_sam_generate_messages_nodejs;lvi_sam_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lvi_sam_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 lvi_sam_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lvi_sam_dep}_FOUND)
      find_package(${lvi_sam_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lvi_sam_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lvi_sam_INCLUDE_DIRS ${${lvi_sam_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lvi_sam_LIBRARIES ${lvi_sam_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lvi_sam_dep}_LIBRARIES})
  _list_append_deduplicate(lvi_sam_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lvi_sam_LIBRARIES ${lvi_sam_LIBRARIES})

  _list_append_unique(lvi_sam_LIBRARY_DIRS ${${lvi_sam_dep}_LIBRARY_DIRS})
  list(APPEND lvi_sam_EXPORTED_TARGETS ${${lvi_sam_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "lvi_sam-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lvi_sam_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
